...
def boot_system():
    print(f"{GREEN}QW Kernel [Version 0.0.9 Extended DOS Edition]")
...
def print_tree(dir_path, prefix=""):
    ...
    try:
        ...
        # Gizli dosyaları ve sistem klasörlerini filtrele
...
def run_dashboard():
    ...
    while True:
        ...
        print(f"{CYAN}========================================={RESET}")
        print(f"{GREEN}        QW KERNEL v0.0.9 DASHBOARD       {RESET}")
        print(f"{CYAN}========================================={RESET}\n")
        ...
        if key == b'\xe0':
            ...
            if selected_index == 0:
                ...
                print(f"{YELLOW}--- About QW Kernel v0.0.9 ---{RESET}\n")
...
def main():
    ...
    while True:
        try:
            ...
            if cmd == "help":
                print(f"{YELLOW}--- QW Kernel v0.0.9 COMMAND LIST ---{RESET}")
                ...
                print(f"{GREEN}QW Kernel v0.0.9 | Platform: {os.name.upper()} | Python {sys.version.split()[0]}{RESET}")
